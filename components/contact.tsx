"use client"; // Added this because we need to handle form submission
...
export default function Contact() {
  ...
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    issueType: 'Social Media Hack', // Default value
    description: ''
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted mb-8 text-lg leading-relaxed">
              Don't wait another day. Our team of experts is ready to help you recover your accounts and funds. All consultations are confidential.
            </p>
            ...
            <div className="space-y-4">
              {/* WhatsApp Link */}
              <a 
                href="https://wa.me/17652742555" 
                target="_blank" 
                rel="noopener noreferrer"
                className="p-5 rounded-2xl bg-surface border border-white/10 flex items-center gap-4 hover:border-primary/50 hover:bg-surface/80 hover:shadow-[0_0_20px_rgba(16,185,129,0.15)] transition-all cursor-pointer group"
              >
              ...
              {/* Email Link */}
              <a 
                href="mailto:marszalekrecovery@gmail.com"
                className="p-5 rounded-2xl bg-surface border border-white/10 flex items-center gap-4 hover:border-primary/50 hover:bg-surface/80 hover:shadow-[0_0_20px_rgba(16,185,129,0.15)] transition-all cursor-pointer group"
              >
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:text-black transition-colors flex-shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-background border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary focus:shadow-[0_0_20px_rgba(16,185,129,0.2)] transition-all"
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2 ml-1">Issue Type</label>
                <select 
                  name="issueType"
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2 ml-1">Describe Your Situation</label>
                <textarea 
                  required
                  name="description"
                  ...
                  className="w-full bg-background border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary focus:shadow-[0_0_20px_rgba(16,185,129,0.2)] transition-all resize-none"
                />
              </div>
              ...
              <button type="submit" className="w-full bg-primary text-black font-bold text-lg py-5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:shadow-[0_0_40px_rgba(16,185,129,0.6)] hover:-translate-y-1">
                Send Message via WhatsApp <Send className="w-5 h-5" />
              </button>
